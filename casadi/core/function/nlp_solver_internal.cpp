...
namespace casadi {
  ...
  void NlpSolverInternal::init() {
    ...
    if (verbose_init)
      userOut() << "Initialized base class in " << diff.proc << " seconds." << endl;
  ...
  Function NlpSolverInternal::getJacF() {
    ...
    if (hasSetOption("jac_f")) {
      ...
      if (verbose_init)
        userOut() << "Generated objective Jacobian in " << diff.proc << " seconds." << endl;
  ...
  Function NlpSolverInternal::getGradF() {
    ...
    if (hasSetOption("grad_f")) {
      ...
      if (verbose_init)
        userOut() << "Generated objective gradient in " << diff.proc << " seconds." << endl;
  ...
  Function NlpSolverInternal::getJacG() {
    ...
    if (hasSetOption("jac_g")) {
      ...
      if (verbose_init)
        userOut() << "Generated constraint Jacobian in " << diff.proc << " seconds." << endl;
      log("Jacobian function generated");
    }
  ...
  Function NlpSolverInternal::getHessLag() {
    ...
    if (hasSetOption("hess_lag")) {
      ...
      const bool gradLagVerbose0 = gradLag->verbose_;
      if (getOption("verbose_init"))
        gradLag->verbose_ = true;
      ...
      if (verbose_init)
        userOut() << "Generated Hessian of the Lagrangian in "
                  << diff.proc << " seconds." << endl;
      gradLag->verbose_ = gradLagVerbose0;
      hessLag->verbose_ = gradLagVerbose0;
